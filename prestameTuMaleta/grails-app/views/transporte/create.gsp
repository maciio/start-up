...
<html>
	...
	<body>
		<a href="#create-transporte" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-transporte" class="content scaffold-create" role="main">
			...
			<g:hasErrors bean="${transporteInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${transporteInstance}" var="error">
